...
export const Hero: React.FC<HeroProps> = ({ onContactClick, onProjectsClick, onArchitectureClick }) => {
  return (
    <section id="hero-section" className="pt-10 sm:pt-16 pb-12">
      ...
      <div className="mt-8 flex flex-wrap items-center gap-3">
        <button
          ...
          className="px-5 py-2.5 rounded-lg bg-neutral-900 text-white dark:bg-neutral-100 dark:text-neutral-950 font-medium text-sm hover:opacity-90 transition-opacity cursor-pointer flex items-center gap-1.5">
        ...
        <button
          ...
          id="btn-hero-contact"
          className="px-4 py-2.5 rounded-lg text-neutral-600 dark:text-neutral-300 hover:text-neutral-900 dark:hover:text-white text-sm font-medium transition-colors cursor-pointer flex items-center gap-1.5">
